<form name="formularioAlterarFotoFundoImoveis" action="index.php" method="post" enctype="multipart/form-data">
	...
	<table class="tabelas-cadastro">
		<tr>
			<td valign="top">
				<fieldset class="conteudo-fielset"><legend class="titulo-fielset">Papel de Parede</legend>
					<table>
						...
						<tr><td >Fundo:</td><td ><input type="file" name="usuario_img" id="usuario_img" /></td></tr>
					</table>
				</fieldset>
			</td>
		</tr>	
		<tr >
			<td colspan="2">
				<fieldset class="conteudo-fielset">
					...
					/>
				<input type="hidden" value="gravarAlteracaoFotoFundoUsuarios" name="tabela"/>
				<input type="hidden" value="gravarAlteracaoFotoFundoUsuarios" name="acao"/>
