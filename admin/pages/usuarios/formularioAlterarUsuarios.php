			...
			<td valign="top">
				<fieldset ><legend >Dados Pessoais</legend>
					...
					?>
						...
						<tr><td>CPF:</td><td><input type="text" name="usuario_cpf" id="usuario_cpf" size="30px" maxlength="14" onkeyup="proximoCampo(this, 'tec_email')" onkeypress="mascara(this, '###.###.###-##')" required="required" placeholder="Digite seu CPF" value="<?php echo $oquefazer->registros->USUARIO_CPF;?>"/></td></tr>
