			...
			<td valign="top">
				<fieldset ><legend >Musica principal</legend>
					<table>
						...
						<tr><td >Clube Champions:</td><td ><input type="text" name="usuario_nome" id="usuario_nome" size="100px" value="<?php echo $oquefazer->registros->CLUBE_CHAMPIONS_NOME;?>" disabled="disabled"/></td></tr>
						<tr><td >Somente selecione arquivos .MP3 :</td><td ><input type="file" name="clube_champions_musica" id="clube_champions_musica" /></td></tr>
					</table>
				</fieldset>
			</td>
		</tr>	
		<tr >
			<td colspan="2">
				<fieldset >
					...
					/>
				<input type="hidden" value="gravarAlteracaoMusicaUsuariosChampions" name="tabela"/>
				<input type="hidden" value="gravarAlteracaoMusicaUsuariosChampions" name="acao"/>
