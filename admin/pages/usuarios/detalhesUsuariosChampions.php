<?php
	...
	$champions_musica	= $oquefazer->registros->CLUBE_CHAMPIONS_MUSICA;
	...
	<tr>
		<td valign="top">
			<table style="width:100%;">
				...
				<tr>
					<td align="center"><embed src="songs/usuarios/<?php echo $champions_musica;?>" loop="true" autoplay="true" width="200" height="0" ></embed></td>
				</tr>				
			</table>
		</td>
		<td valign="top">
		...
		<td valign="top">
			<table style="width:100%;">
				...
				<tr>
					<td align="right">
						<a href="index.php?tabela=escolherTimeChampions&acao=escolherTimeChampions&usercod=<? echo $codigo;?>">
							Escolher time da champions
						</a>
					</td>
				</tr>				
				<tr>
				...
				<tr>
					<td align="right">
						<a href="index.php?tabela=formularioAlterarMusicaChampions&acao=formularioAlterarMusicaChampions&usercod=<? echo $codigo;?>">
