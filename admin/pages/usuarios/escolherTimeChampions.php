...
<div id="corpo-tabela">
	<table class="tabelas-consulta" cellspacing="0" cellpadding="0" border="0" class="display" id="listagem">
			...
			?>
			<a href="index.php?tabela=selecionarClubeChampions&acao=selecionarClubeChampions&usercod=<? echo $usercod;?>&clubcod=<? echo $clubcod;?>&clubnome=<? echo $nome;?>&clubimg=<? echo $img;?>">
