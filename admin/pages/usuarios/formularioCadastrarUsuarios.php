...
<form name="formularioCadastrarTecnicos" action="index.php" method="post">
			...
			<td align="left">
				<div id="navegacao-header">
					<ul>
						...
						<li>></li>
						<li>Inserir Novo Usu&aacute;rio</li>
					</ul>
				</div>
			</td>
		</tr>
	...
	<table width="100%">
		<tr>
			<td valign="top">
				<fieldset ><legend class="titulo-fielset">Dados Pessoais</legend>
					<table width="100%">
						<tr>
							<td>N&iacute;vel:</td>
							<td>
						...
						<tr><td>CPF:</td><td><input type="text" name="usuario_cpf" id="usuario_cpf" size="30px" maxlength="14" onkeyup="proximoCampo(this, 'tec_email')" onkeypress="mascara(this, '###.###.###-##')" required="required" placeholder="Digite seu CPF"/></td></tr>
